          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-semibold text-[#0f172a]">Network Status: Operational</span>
              </div>
              <div className="flex items-center space-x-2">
                <Icon name="CurrencyDollarIcon" size={16} variant="solid" className="text-[#0066ff]" />
                <span className="text-sm font-semibold text-[#0f172a]">CVLT: {tokenPrice}</span>
                <span className="text-xs text-[#059669]">+5.2%</span>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link href="/network-dashboard" className="text-sm font-semibold text-[#0066ff] hover:text-[#0052cc] transition-colors duration-300">
                View Dashboard
              </Link>
              <Link href="/developer-portal" className="px-4 py-2 bg-[#0066ff] text-[#ffffff] rounded-lg text-sm font-cta font-bold hover:bg-[#0052cc] transition-all duration-300">
                Start Building
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <h1 className="text-4xl lg:text-6xl font-headline font-bold text-[#0f172a] mb-6 leading-tight">
              The Future of <span className="text-[#0066ff]">Decentralized</span> Infrastructure
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              <Link href="/developer-portal" className="px-8 py-4 bg-[#0066ff] text-[#ffffff] rounded-lg text-lg font-cta font-bold hover:bg-[#0052cc] transition-all duration-300 shadow-cta-[#0066ff]">
                Get Started
              </Link>
              <Link href="/ecosystem-overview" className="px-8 py-4 bg-[#ffffff] text-[#0f172a] border-2 border-[#0066ff] rounded-lg text-lg font-cta font-bold hover:bg-[#0066ff] hover:text-[#ffffff] transition-all duration-300">
                Explore Ecosystem
              </Link>
            </div>
      ...
      <section className="py-16 lg:py-24 bg-[#e2e8f0]/30">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            ...
            <Link href="/ecosystem-overview" className="hidden lg:flex items-center space-x-2 text-[#0066ff] hover:text-[#0052cc] font-semibold transition-colors duration-300">
          ...
          <div className="text-center lg:hidden">
            <Link href="/ecosystem-overview" className="inline-flex items-center space-x-2 text-[#0066ff] hover:text-[#0052cc] font-semibold transition-colors duration-300">
              <span>View All Projects</span>
              <Icon name="ArrowRightIcon" size={20} variant="outline" />
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <Link href="/developer-portal" className="inline-flex items-center space-x-2 text-[#0066ff] hover:text-[#0052cc] font-semibold transition-colors duration-300">
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#0066ff] to-[#3b82f6]">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/developer-portal" className="px-8 py-4 bg-white text-[#0066ff] rounded-lg text-lg font-cta font-bold hover:bg-gray-100 transition-all duration-300 shadow-cta-[#0066ff]">
              Start Building Now
            </Link>
            <Link href="/network-dashboard" className="px-8 py-4 bg-transparent text-white border-2 border-white rounded-lg text-lg font-cta font-bold hover:bg-white hover:text-[#0066ff] transition-all duration-300">
              View Network Stats
            </Link>
          </div>
        </div>
