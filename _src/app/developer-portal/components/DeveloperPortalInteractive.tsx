...
;\n\n// Connect to CryptoVault EVM mainnet\nconst provider = new ethers.JsonRpcProvider(\n  'https://rpc.cryptovault-evm.io'\n);\n\n// Get network information\nconst network = await provider.getNetwork();\nconsole.log('Connected to:', network.name);\nconsole.log('Chain ID:', network.chainId);\n\n// Get latest block\nconst blockNumber = await provider.getBlockNumber();\nconsole.log('Latest block:', blockNumber);`
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-deep-navy via-secondary to-deep-authority py-20 px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="flex items-center space-x-3 mb-3">
                <Icon name="DocumentTextIcon" size={24} variant="outline" className="text-brand-secondary" />
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="flex items-center space-x-3 mb-3">
                <Icon name="RocketLaunchIcon" size={24} variant="outline" className="text-brand-secondary" />
                <h3 className="text-lg font-headline font-bold text-white">
                  Quick Start
                </h3>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="flex items-center space-x-3 mb-3">
                <Icon name="CurrencyDollarIcon" size={24} variant="outline" className="text-brand-secondary" />
                <h3 className="text-lg font-headline font-bold text-white">
                  Developer Grants
                </h3>
              </div>
      ...
      <section className="py-16 px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <a
              href="#discord"
              className="group bg-card rounded-xl p-6 border border-border hover:border-primary transition-all duration-300 text-center">

              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icon name="ChatBubbleLeftRightIcon" size={32} variant="outline" className="text-primary" />
              </div>
              <h3 className="text-lg font-headline font-bold text-foreground mb-2 group-hover:text-primary transition-colors duration-300">
                Discord
              </h3>
            ...
            <a
              ...
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icon name="CodeBracketIcon" size={32} variant="outline" className="text-primary" />
              </div>
              <h3 className="text-lg font-headline font-bold text-foreground mb-2 group-hover:text-primary transition-colors duration-300">
                GitHub
              </h3>
            ...
            <a
              ...
              <div className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icon name="LifebuoyIcon" size={32} variant="outline" className="text-primary" />
              </div>
              <h3 className="text-lg font-headline font-bold text-foreground mb-2 group-hover:text-primary transition-colors duration-300">
                Support
              </h3>
      ...
      {/* CTA Section */}
      <section className="py-16 px-6 lg:px-8 bg-gradient-to-br from-primary to-cta-blue">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="#testnet"
              className="px-8 py-4 bg-white text-primary rounded-lg text-lg font-cta font-bold hover:bg-gray-100 transition-all duration-300 shadow-lg">
